"use strict";(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[609],{8779:function(e,t,r){r.d(t,{ET:function(){return iG},JU:function(){return s7},PL:function(){return iB},QT:function(){return iq},ad:function(){return ii},hJ:function(){return s8},oe:function(){return iK},pl:function(){return i$},r7:function(){return ij}});var n,s,i,a,o=r(7683),l=r(3313),u=r(4419),h=r(2345),c=r(8597),d=r(2841);r(9079);var m=r(3663).lW;let f="@firebase/firestore",g="4.9.1";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let id=/^__.*__$/;class im{constructor(e,t,r){this.data=e,this.fieldMask=t,this.fieldTransforms=r}toMutation(e,t){return null!==this.fieldMask?new t4(e,this.data,this.fieldMask,t,this.fieldTransforms):new t3(e,this.data,t,this.fieldTransforms)}}class ig{constructor(e,t,r){this.data=e,this.fieldMask=t,this.fieldTransforms=r}toMutation(e,t){return new t4(e,this.data,this.fieldMask,t,this.fieldTransforms)}}function ip(e){switch(e){case 0:case 2:case 1:return!0;case 3:case 4:return!1;default:throw I(40011,{Ac:e})}}class iy{constructor(e,t,r,n,s,i){this.settings=e,this.databaseId=t,this.serializer=r,this.ignoreUndefinedProperties=n,void 0===s&&this.Rc(),this.fieldTransforms=s||[],this.fieldMask=i||[]}get path(){return this.settings.path}get Ac(){return this.settings.Ac}Vc(e){return new iy({...this.settings,...e},this.databaseId,this.serializer,this.ignoreUndefinedProperties,this.fieldTransforms,this.fieldMask)}mc(e){let t=this.path?.child(e),r=this.Vc({path:t,fc:!1});return r.gc(e),r}yc(e){let t=this.path?.child(e),r=this.Vc({path:t,fc:!1});return r.Rc(),r}wc(e){return this.Vc({path:void 0,fc:!0})}Sc(e){return ik(e,this.settings.methodName,this.settings.bc||!1,this.path,this.settings.Dc)}contains(e){return void 0!==this.fieldMask.find(t=>e.isPrefixOf(t))||void 0!==this.fieldTransforms.find(t=>e.isPrefixOf(t.field))}Rc(){if(this.path)for(let e=0;e<this.path.length;e++)this.gc(this.path.get(e))}gc(e){if(0===e.length)throw this.Sc("Document fields must not be empty");if(ip(this.Ac)&&id.test(e))throw this.Sc('Document fields cannot begin and end with "__"')}}class iw{constructor(e,t,r){this.databaseId=e,this.ignoreUndefinedProperties=t,this.serializer=r||nb(e)}Cc(e,t,r,n=!1){return new iy({Ac:e,methodName:t,Dc:r,path:Q.emptyPath(),fc:!1,bc:n},this.databaseId,this.serializer,this.ignoreUndefinedProperties)}}function iv(e){let t=e._freezeSettings(),r=nb(e._databaseId);return new iw(e._databaseId,!!t.ignoreUndefinedProperties,r)}function iE(e,t,r,n,s,i={}){let a,o;let l=e.Cc(i.merge||i.mergeFields?2:0,t,r,s);iC("Data must be an object, but it was:",l,n);let u=iS(n,l);if(i.merge)a=new e_(l.fieldMask),o=l.fieldTransforms;else if(i.mergeFields){let e=[];for(let n of i.mergeFields){let s=iN(t,n,r);if(!l.contains(s))throw new A(b.INVALID_ARGUMENT,`Field '${s}' is specified in your field mask but missing from your input data.`);iD(e,s)||e.push(s)}a=new e_(e),o=l.fieldTransforms.filter(e=>a.covers(e.field))}else a=null,o=l.fieldTransforms;return new im(new e4(u),a,o)}class i_ extends iu{_toFieldTransform(e){if(2!==e.Ac)throw 1===e.Ac?e.Sc(`${this._methodName}() can only appear at the top level of your update data`):e.Sc(`${this._methodName}() cannot be used with set() unless you pass {merge:true}`);return e.fieldMask.push(e.path),null}isEqual(e){return e instanceof i_}}function iT(e,t){if(iI(e=(0,h.m9)(e)))return iC("Unsupported field value:",t,e),iS(e,t);if(e instanceof iu)return function(e,t){if(!ip(t.Ac))throw t.Sc(`${e._methodName}() can only be used with update() and set()`);if(!t.path)throw t.Sc(`${e._methodName}() is not currently supported inside arrays`);let r=e._toFieldTransform(t);r&&t.fieldTransforms.push(r)}(e,t),null;if(void 0===e&&t.ignoreUndefinedProperties)return null;if(t.path&&t.fieldMask.push(t.path),e instanceof Array){if(t.settings.fc&&4!==t.Ac)throw t.Sc("Nested arrays are not supported");return function(e,t){let r=[],n=0;for(let s of e){let e=iT(s,t.wc(n));null==e&&(e={nullValue:"NULL_VALUE"}),r.push(e),n++}return{arrayValue:{values:r}}}(e,t)}return function(e,t){var r,n,s;if(null===(e=(0,h.m9)(e)))return{nullValue:"NULL_VALUE"};if("number"==typeof e)return r=t.serializer,"number"==typeof(s=n=e)&&Number.isInteger(s)&&!ed(s)&&s<=Number.MAX_SAFE_INTEGER&&s>=Number.MIN_SAFE_INTEGER?tU(n):tF(r,n);if("boolean"==typeof e)return{booleanValue:e};if("string"==typeof e)return{stringValue:e};if(e instanceof Date){let r=en.fromDate(e);return{timestampValue:rI(t.serializer,r)}}if(e instanceof en){let r=new en(e.seconds,1e3*Math.floor(e.nanoseconds/1e3));return{timestampValue:rI(t.serializer,r)}}if(e instanceof ih)return{geoPointValue:{latitude:e.latitude,longitude:e.longitude}};if(e instanceof io)return{bytesValue:rC(t.serializer,e._byteString)};if(e instanceof s9){let r=t.databaseId,n=e.firestore._databaseId;if(!n.isEqual(r))throw t.Sc(`Document reference is for database ${n.projectId}/${n.database} but should be for database ${r.projectId}/${r.database}`);return{referenceValue:rb(e.firestore._databaseId||t.databaseId,e._key.path)}}if(e instanceof ic)return{mapValue:{fields:{[eF]:{stringValue:ez},[eB]:{arrayValue:{values:e.toArray().map(e=>{if("number"!=typeof e)throw t.Sc("VectorValues must only contain numeric values.");return tF(t.serializer,e)})}}}}};throw t.Sc(`Unsupported field value: ${Z(e)}`)}(e,t)}function iS(e,t){let r={};return eg(e)?t.path&&t.path.length>0&&t.fieldMask.push(t.path):ef(e,(e,n)=>{let s=iT(n,t.mc(e));null!=s&&(r[e]=s)}),{mapValue:{fields:r}}}function iI(e){return!("object"!=typeof e||null===e||e instanceof Array||e instanceof Date||e instanceof en||e instanceof ih||e instanceof io||e instanceof s9||e instanceof iu||e instanceof ic)}function iC(e,t,r){if(!iI(r)||!J(r)){let n=Z(r);throw"an object"===n?t.Sc(e+" a custom object"):t.Sc(e+" "+n)}}function iN(e,t,r){if((t=(0,h.m9)(t))instanceof il)return t._internalPath;if("string"==typeof t)return iA(e,t);throw ik("Field path arguments must be of type string or ",e,!1,void 0,r)}let ib=RegExp("[~\\*/\\[\\]]");function iA(e,t,r){if(t.search(ib)>=0)throw ik(`Invalid field path (${t}). Paths must not contain '~', '*', '/', '[', or ']'`,e,!1,void 0,r);try{return new il(...t.split("."))._internalPath}catch(n){throw ik(`Invalid field path (${t}). Paths must not be empty, begin with '.', end with '.', or contain '..'`,e,!1,void 0,r)}}function ik(e,t,r,n,s){let i=n&&!n.isEmpty(),a=void 0!==s,o=`Function ${t}() called with invalid data`;r&&(o+=" (via `toFirestore()`)"),o+=". ";let l="";return(i||a)&&(l+=" (found",i&&(l+=` in field ${n}`),a&&(l+=` in document ${s}`),l+=")"),new A(b.INVALID_ARGUMENT,o+e+l)}function iD(e,t){return e.some(e=>e.isEqual(t))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function iq(e){e=ee(e,s9);let t=ee(e.firestore,is);return(function(e,t,r={}){let n=new k;return e.asyncQueue.enqueueAndForget(async()=>(function(e,t,r,n,s){let i=new sG({next:o=>{i.Nu(),t.enqueueAndForget(()=>su(e,a));let l=o.docs.has(r);!l&&o.fromCache?s.reject(new A(b.UNAVAILABLE,"Failed to get document because the client is offline.")):l&&o.fromCache&&n&&"server"===n.source?s.reject(new A(b.UNAVAILABLE,'Failed to get document from server. (However, this document does exist in the local cache. Run again without setting source to "server" to retrieve the cached document.)')):s.resolve(o)},error:e=>s.reject(e)}),a=new sm(new tw(r.path),i,{includeMetadataChanges:!0,qa:!0});return sl(e,a)})(await sZ(e),e.asyncQueue,t,r,n)),n.promise})(ia(t),e._key).then(r=>(function(e,t,r){let n=r.docs.get(t._key),s=new iz(e);return new iP(e,s,t._key,n,new iO(r.hasPendingWrites,r.fromCache),t.converter)})(t,e,r))}iU._jsonSchemaVersion="firestore/querySnapshot/1.0",iU._jsonSchema={type:et("string",iU._jsonSchemaVersion),bundleSource:et("string","QuerySnapshot"),bundleName:et("string"),bundle:et("string")};class iz extends iL{constructor(e){super(),this.firestore=e}convertBytes(e){return new io(e)}convertReference(e){let t=this.convertDocumentKey(e,this.firestore._databaseId);return new s9(this.firestore,null,t)}}function iB(e){e=ee(e,s6);let t=ee(e.firestore,is),r=ia(t),n=new iz(t);return(/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function(e){if("L"===e.limitType&&0===e.explicitOrderBy.length)throw new A(b.UNIMPLEMENTED,"limitToLast() queries require specifying at least one orderBy() clause")}(e._query),(function(e,t,r={}){let n=new k;return e.asyncQueue.enqueueAndForget(async()=>(function(e,t,r,n,s){let i=new sG({next:r=>{i.Nu(),t.enqueueAndForget(()=>su(e,a)),r.fromCache&&"server"===n.source?s.reject(new A(b.UNAVAILABLE,'Failed to get documents from server. (However, these documents may exist in the local cache. Run again without setting source to "server" to retrieve the cached documents.)')):s.resolve(r)},error:e=>s.reject(e)}),a=new sm(r,i,{includeMetadataChanges:!0,qa:!0});return sl(e,a)})(await sZ(e),e.asyncQueue,t,r,n)),n.promise})(r,e._query).then(r=>new iU(t,n,e,r)))}function i$(e,t,r){e=ee(e,s9);let n=ee(e.firestore,is),s=iM(e.converter,t,r);return iQ(n,[iE(iv(n),"setDoc",e._key,s,null!==e.converter,r).toMutation(e._key,tY.none())])}function ij(e,t,r,...n){e=ee(e,s9);let s=ee(e.firestore,is),i=iv(s);return iQ(s,[("string"==typeof(t=(0,h.m9)(t))||t instanceof il?function(e,t,r,n,s,i){let a=e.Cc(1,t,r),o=[iN(t,n,r)],l=[s];if(i.length%2!=0)throw new A(b.INVALID_ARGUMENT,`Function ${t}() needs to be called with an even number of arguments that alternate between field names and values.`);for(let e=0;e<i.length;e+=2)o.push(iN(t,i[e])),l.push(i[e+1]);let u=[],c=e4.empty();for(let e=o.length-1;e>=0;--e)if(!iD(u,o[e])){let t=o[e],r=l[e];r=(0,h.m9)(r);let n=a.yc(t);if(r instanceof i_)u.push(t);else{let e=iT(r,n);null!=e&&(u.push(t),c.set(t,e))}}return new ig(c,new e_(u),a.fieldTransforms)}(i,"updateDoc",e._key,t,r,n):function(e,t,r,n){let s=e.Cc(1,t,r);iC("Data must be an object, but it was:",s,n);let i=[],a=e4.empty();return ef(n,(e,n)=>{let o=iA(t,e,r);n=(0,h.m9)(n);let l=s.yc(o);if(n instanceof i_)i.push(o);else{let e=iT(n,l);null!=e&&(i.push(o),a.set(o,e))}}),new ig(a,new e_(i),s.fieldTransforms)}(i,"updateDoc",e._key,t)).toMutation(e._key,tY.exists(!0))])}function iK(e){return iQ(ee(e.firestore,is),[new t8(e._key,tY.none())])}function iG(e,t){let r=ee(e.firestore,is),n=s7(e),s=iM(e.converter,t);return iQ(r,[iE(iv(e.firestore),"addDoc",n._key,s,null!==e.converter,{}).toMutation(n._key,tY.exists(!1))]).then(()=>n)}function iQ(e,t){return function(e,t){let r=new k;return e.asyncQueue.enqueueAndForget(async()=>sb(await sJ(e).then(e=>e.syncEngine),t,r)),r.promise}(ia(e),t)}new WeakMap,function(e=!0){y=o.Jn,(0,o.Xd)(new l.wA("firestore",(t,{instanceIdentifier:r,options:n})=>{let s=t.getProvider("app").getImmediate(),i=new is(new V(t.getProvider("auth-internal")),new P(s,t.getProvider("app-check-internal")),function(e,t){if(!Object.prototype.hasOwnProperty.apply(e.options,["projectId"]))throw new A(b.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new eP(e.options.projectId,t)}(s,r),s);return n={useFetchStreams:e,...n},i._setSettings(n),i},"PUBLIC").setMultipleInstances(!0)),(0,o.KN)(f,g,void 0),(0,o.KN)(f,g,"esm2020")}()}}]);